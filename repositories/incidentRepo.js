...
export async function upsert(homeId, data) {
  ...
  const { rows } = await pool.query(
    ...
    [
      ...
      data.msp_person_involved || false,
...
export async function update(id, homeId, data) {
  ...
  const { rows } = await pool.query(
    `UPDATE incidents SET
       ...
       person_affected = COALESCE($9, person_affected),
       person_affected_name = COALESCE($10, person_affected_name),
       staff_involved = COALESCE($11, staff_involved),
       immediate_action = COALESCE($12, immediate_action),
       medical_attention = COALESCE($13, medical_attention),
       hospital_attendance = COALESCE($14, hospital_attendance),
       cqc_notifiable = COALESCE($15, cqc_notifiable),
       cqc_notification_type = COALESCE($16, cqc_notification_type),
       cqc_notification_deadline = COALESCE($17, cqc_notification_deadline),
       cqc_notified = COALESCE($18, cqc_notified),
       cqc_notified_date = COALESCE($19, cqc_notified_date),
       cqc_reference = COALESCE($20, cqc_reference),
       riddor_reportable = COALESCE($21, riddor_reportable),
       riddor_category = COALESCE($22, riddor_category),
       riddor_reported = COALESCE($23, riddor_reported),
       riddor_reported_date = COALESCE($24, riddor_reported_date),
       riddor_reference = COALESCE($25, riddor_reference),
       safeguarding_referral = COALESCE($26, safeguarding_referral),
       safeguarding_to = COALESCE($27, safeguarding_to),
       safeguarding_reference = COALESCE($28, safeguarding_reference),
       safeguarding_date = COALESCE($29, safeguarding_date),
       witnesses = COALESCE($30, witnesses),
       duty_of_candour_applies = COALESCE($31, duty_of_candour_applies),
       candour_notification_date = COALESCE($32, candour_notification_date),
       candour_letter_sent_date = COALESCE($33, candour_letter_sent_date),
       candour_recipient = COALESCE($34, candour_recipient),
       police_involved = COALESCE($35, police_involved),
       police_reference = COALESCE($36, police_reference),
       police_contact_date = COALESCE($37, police_contact_date),
       msp_wishes_recorded = COALESCE($38, msp_wishes_recorded),
       msp_outcome_preferences = COALESCE($39, msp_outcome_preferences),
       msp_person_involved = COALESCE($40, msp_person_involved),
       investigation_status = COALESCE($41, investigation_status),
       investigation_start_date = COALESCE($42, investigation_start_date),
       investigation_lead = COALESCE($43, investigation_lead),
       investigation_review_date = COALESCE($44, investigation_review_date),
       root_cause = COALESCE($45, root_cause),
       lessons_learned = COALESCE($46, lessons_learned),
       investigation_closed_date = COALESCE($47, investigation_closed_date),
       corrective_actions = COALESCE($48, corrective_actions),
       updated_at = $49
    ...
    [
      ...
      data.time !== undefined ? data.time : null,
      data.location !== undefined ? data.location : null,
      data.type !== undefined ? data.type : null,
      data.severity !== undefined ? data.severity : null,
      data.description !== undefined ? data.description : null,
      data.person_affected !== undefined ? data.person_affected : null,
      data.person_affected_name !== undefined ? data.person_affected_name : null,
      data.staff_involved !== undefined ? JSON.stringify(data.staff_involved) : null,
      data.immediate_action !== undefined ? data.immediate_action : null,
      data.medical_attention !== undefined ? data.medical_attention : null,
      data.hospital_attendance !== undefined ? data.hospital_attendance : null,
      data.cqc_notifiable !== undefined ? data.cqc_notifiable : null,
      data.cqc_notification_type !== undefined ? data.cqc_notification_type : null,
      data.cqc_notification_deadline !== undefined ? data.cqc_notification_deadline : null,
      data.cqc_notified !== undefined ? data.cqc_notified : null,
      data.cqc_notified_date !== undefined ? data.cqc_notified_date : null,
      data.cqc_reference !== undefined ? data.cqc_reference : null,
      data.riddor_reportable !== undefined ? data.riddor_reportable : null,
      data.riddor_category !== undefined ? data.riddor_category : null,
      data.riddor_reported !== undefined ? data.riddor_reported : null,
      data.riddor_reported_date !== undefined ? data.riddor_reported_date : null,
      data.riddor_reference !== undefined ? data.riddor_reference : null,
      data.safeguarding_referral !== undefined ? data.safeguarding_referral : null,
      data.safeguarding_to !== undefined ? data.safeguarding_to : null,
      data.safeguarding_reference !== undefined ? data.safeguarding_reference : null,
      data.safeguarding_date !== undefined ? data.safeguarding_date : null,
      data.witnesses !== undefined ? JSON.stringify(data.witnesses) : null,
      data.duty_of_candour_applies !== undefined ? data.duty_of_candour_applies : null,
      data.candour_notification_date !== undefined ? data.candour_notification_date : null,
      data.candour_letter_sent_date !== undefined ? data.candour_letter_sent_date : null,
      data.candour_recipient !== undefined ? data.candour_recipient : null,
      data.police_involved !== undefined ? data.police_involved : null,
      data.police_reference !== undefined ? data.police_reference : null,
      data.police_contact_date !== undefined ? data.police_contact_date : null,
      data.msp_wishes_recorded !== undefined ? data.msp_wishes_recorded : null,
      data.msp_outcome_preferences !== undefined ? data.msp_outcome_preferences : null,
      data.msp_person_involved !== undefined ? data.msp_person_involved : null,
      data.investigation_status !== undefined ? data.investigation_status : null,
      data.investigation_start_date !== undefined ? data.investigation_start_date : null,
      data.investigation_lead !== undefined ? data.investigation_lead : null,
      data.investigation_review_date !== undefined ? data.investigation_review_date : null,
      data.root_cause !== undefined ? data.root_cause : null,
      data.lessons_learned !== undefined ? data.lessons_learned : null,
      data.investigation_closed_date !== undefined ? data.investigation_closed_date : null,
