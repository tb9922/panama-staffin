...
export const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/handover', label: 'Handover Book', ownDataSafe: true, icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/payroll/monthly-timesheet', label: 'Monthly View', ownDataSafe: true, icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/scan-inbox', label: 'Scan Inbox', requiresAnyModules: SCAN_INTAKE_ACCESS_MODULES, requiresScanIntake: true, icon: 'M3 7h18M5 7l2-3h10l2 3m-1 0v10a2 2 0 01-2 2H7a2 2 0 01-2-2V7m4 4h6m-6 4h6' },
      { path: '/audit', label: 'Audit Log', module: 'reports', platformAdminOnly: true, icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
