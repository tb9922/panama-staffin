...
// IDs use CQC's per-category numbering: S1-S8, E1-E6, C1-C3, R1-R5, WL1-WL7.
...
export const QUALITY_STATEMENTS = [
  ...
  },
  {
    ...
    cqcRef: 'Regulation 9 — Person-Centred Care (QS19)',
  ...
  },
  {
    ...
    cqcRef: 'Regulation 10 — Dignity & Respect (QS20)',
  ...
  },
  {
    ...
    cqcRef: 'Regulation 16 — Complaints (QS21)',
  ...
  },
  {
    ...
    cqcRef: 'Regulation 9 — Person-Centred Care (QS22)',
  ...
  // ── Well-Led (WL1-WL7) — Regulation 17, 18 ────────────────────────────────
  {
    id: 'WL1', category: 'well-led', name: 'Shared Direction & Culture',
    cqcRef: 'Regulation 17 — Good Governance (QS23)',
  ...
  },
  {
    ...
    cqcRef: 'Regulation 17 — Good Governance (QS24)',
  ...
  },
  {
    ...
    cqcRef: 'Regulation 18 — Staffing (QS26)',
...
export function calculateComplianceScore(data, dateRange, asOfDate) {
  ...
  return {
    engine_version: ENGINE_VERSION, overallScore, band, metrics, questionScores,
    limitingQuestions, availableMetrics, unavailableMetrics, availableWeight: totalWeight,
  };
}
