    ...
    <div className={PAGE.container}>
      <div className={PAGE.header}>
        ...
        <div className="flex gap-2">
          ...
          <button className={BTN.primary + ' ' + BTN.sm} onClick={openNew}>New Request</button>
        </div>
      </div>
      ...
      {showModal && (
        <div className={MODAL.overlay} onClick={e => e.target === e.currentTarget && setShowModal(false)}>
          <div className={MODAL.panelXl} onClick={e => e.stopPropagation()}>
            <h3 className={MODAL.title}>{editing ? 'Edit Flexible Working Request' : 'New Flexible Working Request'}</h3>
