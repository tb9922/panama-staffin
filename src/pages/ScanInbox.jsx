                    ...
                    <div className="space-y-3">
                      ...
                      {financeForm.target_type === 'create_expense' && (
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                          ...
                          <div><label className={INPUT.label}>Net</label><input type="number" step="0.01" inputMode="decimal" className={INPUT.base} value={financeForm.expense.net_amount} onChange={(e) => setFinanceForm((current) => ({ ...current, expense: { ...current.expense, net_amount: e.target.value } }))} /></div>
                          <div><label className={INPUT.label}>VAT</label><input type="number" step="0.01" inputMode="decimal" className={INPUT.base} value={financeForm.expense.vat_amount} onChange={(e) => setFinanceForm((current) => ({ ...current, expense: { ...current.expense, vat_amount: e.target.value } }))} /></div>
                          <div><label className={INPUT.label}>Gross</label><input type="number" step="0.01" inputMode="decimal" className={INPUT.base} value={financeForm.expense.gross_amount} onChange={(e) => setFinanceForm((current) => ({ ...current, expense: { ...current.expense, gross_amount: e.target.value } }))} /></div>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {target === 'handover' && (
                    <div className="space-y-3">
                      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                        ...
                        <div><label className={INPUT.label}>Shift</label><select className={INPUT.select} value={handoverForm.shift} onChange={(e) => setHandoverForm((current) => ({ ...current, shift: e.target.value }))}><option value="E">Early Shift</option><option value="L">Late Shift</option><option value="EL">Early + Late Shift</option><option value="N">Night Shift</option></select></div>
