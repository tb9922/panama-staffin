...
const EMPTY_FORM = {
  ...
  cqc_notified: false, cqc_notified_date: '', cqc_notified_time: '', cqc_reference: '',
  riddor_reportable: false, riddor_category: '', riddor_reported: false,
  riddor_reported_date: '', riddor_reported_time: '', riddor_reference: '',
...
export default function IncidentTracker() {
  ...
  function openEdit(inc) {
    ...
    setForm({
      ...
      cqc_notified: !!inc.cqc_notified, cqc_notified_date: inc.cqc_notified_date || '', cqc_notified_time: inc.cqc_notified_time || '',
      cqc_reference: inc.cqc_reference || '',
      riddor_reportable: !!inc.riddor_reportable, riddor_category: inc.riddor_category || '',
      riddor_reported: !!inc.riddor_reported, riddor_reported_date: inc.riddor_reported_date || '', riddor_reported_time: inc.riddor_reported_time || '',
