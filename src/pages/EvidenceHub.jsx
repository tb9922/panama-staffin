...
export default function EvidenceHub() {
  ...
  }, [debouncedSearch, filters.uploadedBy, filters.dateFrom, filters.dateTo, filters.modules, offset]);
  ...
  return (
    <div className={PAGE.container}>
      ...
      <div className={CARD.flush}>
        ...
        {loading ? (
          <div className="px-4 py-10 text-sm text-gray-500" role="status">Loading evidence...</div>
        ) : rows.length === 0 ? (
