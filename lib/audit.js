...
import { STAFF_SENSITIVE_FIELDS } from '../shared/staffPolicy.js';
...
const SENSITIVE_FIELDS = new Set([
  ...STAFF_SENSITIVE_FIELDS,
  'ni_number', 'date_of_birth', 'hourly_rate', 'contract_hours',
  'phone', 'address', 'emergency_contact', 'postcode', 'home_postcode',
  'internal_bank_notes', 'notes', 'reference', 'verified_by', 'verifier_name',
  'active', 'wtr_opt_out', 'al_entitlement', 'al_carryover',
  'willing_extras', 'willing_other_homes', 'max_weekly_hours_topup',
  'max_travel_radius_km', 'internal_bank_status',
  'password_hash', 'secret', 'secret_encrypted', 'secret_iv', 'secret_tag',
  'edit_lock_pin',
  'ni_category', 'tax_code', 'student_loan_plan', 'bank_details',
  'iban', 'sort_code', 'account_number', 'bank_account',
  'funding_reference', 'top_up_payer', 'top_up_contact',
  ...
  'subject_summary', 'subject_detail', 'desired_outcome', 'employee_statement_at_hearing',
  'protected_characteristic',
  'concern_summary', 'concern_detail', 'informal_discussion_notes', 'evidence_items',
  'informal_targets', 'pip_objectives', 'summary', 'key_points',
  'reason', 'absence_reason', 'questions_for_oh', 'report_summary',
  'fit_for_role', 'disability_likely', 'estimated_return_date',
