...
app.use('/api/finance/docs', financeDocsRouter);
app.use('/api/finance/suppliers', suppliersRouter);
app.use('/api/finance',  financeRouter);
app.use('/api/incidents', incidentsRouter);
app.use('/api/complaints', complaintsRouter);
app.use('/api/maintenance/docs', maintenanceDocsRouter);
...
app.use('/api/cqc/docs', cqcDocsRouter);
...
app.use('/api/onboarding/docs', onboardingDocsRouter);
