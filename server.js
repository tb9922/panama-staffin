...
import evidenceQualityRouter from './routes/evidenceQuality.js';
...
import portfolioSnapshotsRouter from './routes/portfolioSnapshots.js';
...
import homeSetupRouter from './routes/homeSetup.js';
import scanIntakeRouter from './routes/scanIntake.js';
import opsStatusRouter from './routes/opsStatus.js';
import operationalReviewsRouter from './routes/operationalReviews.js';
...
app.use('/api/evidence-quality', evidenceQualityRouter);
...
app.use('/api/portfolio-snapshots', portfolioSnapshotsRouter);
...
app.use('/api/home-setup', homeSetupRouter);
app.use('/api/scan-intake', scanIntakeRouter);
app.use('/api/ops', opsStatusRouter);
app.use('/api/operational-reviews', operationalReviewsRouter);
