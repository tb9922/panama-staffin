...
const routeChecks = [
  ...
  { path: '/internal-bank', ready: async page => expect(page.getByRole('heading', { name: 'Internal Bank' })).toBeVisible({ timeout: 30_000 }) },
  ...
  { path: '/actions', ready: async page => expect(page.getByRole('heading', { name: 'Manager Actions' })).toBeVisible({ timeout: 30_000 }) },
  { path: '/audit-calendar', ready: async page => expect(page.getByRole('heading', { name: 'Audit Calendar' })).toBeVisible({ timeout: 30_000 }) },
  ...
  { path: '/hr/reflective-practice', ready: async page => expect(page.getByRole('heading', { name: 'Reflective Practice' })).toBeVisible({ timeout: 30_000 }) },
  ...
  { path: '/payroll/agency', ready: async page => expect(page.getByRole('heading', { name: 'Agency Tracker' })).toBeVisible({ timeout: 30_000 }) },
  { path: '/gdpr', ready: async page => expect(page.getByRole('heading', { name: 'GDPR & Data Protection' })).toBeVisible({ timeout: 30_000 }) },
  { path: '/portfolio', ready: async page => expect(page.getByRole('heading', { name: 'Portfolio Dashboard' })).toBeVisible({ timeout: 30_000 }) },
  { path: '/outcomes', ready: async page => expect(page.getByRole('heading', { name: 'Outcome Metrics' })).toBeVisible({ timeout: 30_000 }) },
