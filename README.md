...
- `npm test`: run locally in your branch to verify the current baseline
...
The current test baseline changes frequently. Run `npm test`,
`npm run test:frontend`, and `npm run test:e2e` in your branch to verify the
current unit, integration, page, and browser coverage.

For current file-count baselines, run `npm run stats`.
